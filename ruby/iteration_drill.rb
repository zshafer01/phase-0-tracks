...
# 3. Create a method to see if a particular item (string) is in the zombie_apocalypse_supplies. Do not use any special built-in methods.
...
# 5. We just found out that the Passenger Pigeon is actually not extinct! Remove them from extinct_animals and return the key value pair as a two item array. Find the built-in method that helps you accomplish this in the Ruby documentation for Hashes.
# ----
